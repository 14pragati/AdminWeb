...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The add_support_user recording.
    /// </summary>
    [TestModule("0c2536c9-6eda-44ea-a7f3-d141eaee0fbf", ModuleType.Recording, 1)]
    public partial class add_support_user : ITestModule
    {
        /// <summary>
        ...
        static add_support_user instance = new add_support_user();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public add_support_user()
        {
            Random_email = "";
        }
        ...
        /// </summary>
        public static add_support_user Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// </summary>
        [TestVariable("c4df711a-3eee-434a-841d-e0d5c046dd09")]
        ...
        void ITestModule.Run()
        {
            ...
            try {
                Report.Log(ReportLevel.Info, "Keyboard", "(Optional Action)\r\nKey sequence 'support' with focus on 'AdminWebapp.LastName'.", repo.AdminWebapp.LastNameInfo, new RecordItemIndex(8));
                repo.AdminWebapp.LastName.PressKeys("support");
                Delay.Milliseconds(0);
            } catch(Exception ex) { Report.Log(ReportLevel.Warn, "Module", "(Optional Action) " + ex.Message, new RecordItemIndex(8)); }
            
            try {
                Report.Log(ReportLevel.Info, "Keyboard", "(Optional Action)\r\nKey sequence 'Pentair_India_Ranorex_Support' with focus on 'AdminWebapp.Root.Address1'.", repo.AdminWebapp.Root.Address1Info, new RecordItemIndex(9));
                repo.AdminWebapp.Root.Address1.PressKeys("Pentair_India_Ranorex_Support");
                Delay.Milliseconds(0);
            ...
            try {
                Report.Log(ReportLevel.Info, "Keyboard", "(Optional Action)\r\nKey sequence '9971132377' with focus on 'AdminWebapp.Root.InputTagTel'.", repo.AdminWebapp.Root.InputTagTelInfo, new RecordItemIndex(16));
                repo.AdminWebapp.Root.InputTagTel.PressKeys("9971132377");
                Delay.Milliseconds(0);
            ...
            try {
                Report.Log(ReportLevel.Info, "Validation", "(Optional Action)\r\nValidating AttributeEqual (TagName='span') on item 'AdminWebapp1.Root.CreateSupportUser'.", repo.AdminWebapp1.Root.CreateSupportUserInfo, new RecordItemIndex(35));
                Validate.AttributeEqual(repo.AdminWebapp1.Root.CreateSupportUserInfo, "TagName", "span", null, false);
                Delay.Milliseconds(0);
