...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The Validate_admin_user_search recording.
    /// </summary>
    [TestModule("8cc95bb5-084b-4edc-87ba-17d82accaf85", ModuleType.Recording, 1)]
    public partial class Validate_admin_user_search : ITestModule
    {
        /// <summary>
        ...
        static Validate_admin_user_search instance = new Validate_admin_user_search();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public Validate_admin_user_search()
        {
            fname = "";
            lname = "";
            email = "";
        ...
        /// </summary>
        public static Validate_admin_user_search Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// </summary>
        [TestVariable("2def36c4-5bfe-459b-a5fc-594cab62a38e")]
        public string fname
        {
            get { return _fname; }
            set { _fname = value; }
        ...
        /// </summary>
        [TestVariable("b966937b-5ebc-40f9-a57f-9a60a2748b5a")]
        public string lname
        {
            get { return _lname; }
            set { _lname = value; }
        ...
        /// </summary>
        [TestVariable("7376b3f1-21fd-4713-a959-99e0d8ffd8a3")]
        public string phone
        {
            get { return _phone; }
            set { _phone = value; }
        ...
        /// </summary>
        [TestVariable("91a149ec-085b-477c-ac59-fae45afe8a09")]
        public string email
        {
        ...
        void ITestModule.Run()
        {
            ...
            try {
                Report.Log(ReportLevel.Info, "Validation", "(Optional Action)\r\nValidating AttributeEqual (TagName='div') on item 'AdminWebapp1.ColMd8'.", repo.AdminWebapp1.ColMd8Info, new RecordItemIndex(33));
                Validate.AttributeEqual(repo.AdminWebapp1.ColMd8Info, "TagName", "div", null, false);
                Delay.Milliseconds(0);
            } catch(Exception ex) { Report.Log(ReportLevel.Warn, "Module", "(Optional Action) " + ex.Message, new RecordItemIndex(33)); }
            
            try {
                Report.Log(ReportLevel.Info, "Validation", "(Optional Action)\r\nValidating AttributeEqual (TagName='th') on item 'AdminWebapp1.TdThProp'.", repo.AdminWebapp1.TdThPropInfo, new RecordItemIndex(34));
            ...
            try {
                Report.Log(ReportLevel.Info, "Validation", "(Optional Action)\r\nValidating AttributeEqual (TagName='span') on item 'AdminWebapp1.LastName'.", repo.AdminWebapp1.LastNameInfo, new RecordItemIndex(35));
            ...
            try {
                Report.Log(ReportLevel.Info, "Validation", "(Optional Action)\r\nValidating AttributeEqual (TagName='span') on item 'AdminWebapp1.Root.EmailAddress'.", repo.AdminWebapp1.Root.EmailAddressInfo, new RecordItemIndex(36));
            ...
            try {
                Report.Log(ReportLevel.Info, "Validation", "(Optional Action)\r\nValidating AttributeEqual (TagName='span') on item 'AdminWebapp1.Root.PrimaryPhone'.", repo.AdminWebapp1.Root.PrimaryPhoneInfo, new RecordItemIndex(37));
            ...
            try {
                Report.Log(ReportLevel.Info, "Validation", "(Optional Action)\r\nValidating AttributeEqual (TagName='img') on item 'AdminWebapp1.Root.Edit'.", repo.AdminWebapp1.Root.EditInfo, new RecordItemIndex(38));
            ...
            try {
                Report.Log(ReportLevel.Info, "Mouse", "(Optional Action)\r\nMouse Left Click item 'AdminWebapp.SearchMenuDropdown' at Center.", repo.AdminWebapp.SearchMenuDropdownInfo, new RecordItemIndex(39));
                repo.AdminWebapp.SearchMenuDropdown.Click();
                Delay.Milliseconds(0);
            } catch(Exception ex) { Report.Log(ReportLevel.Warn, "Module", "(Optional Action) " + ex.Message, new RecordItemIndex(39)); }
            
            try {
                Report.Log(ReportLevel.Info, "Mouse", "(Optional Action)\r\nMouse Left Click item 'AdminWebapp.SearchMenuPrimaryPhone' at Center.", repo.AdminWebapp.SearchMenuPrimaryPhoneInfo, new RecordItemIndex(40));
            ...
            try {
                Report.Log(ReportLevel.Info, "Keyboard", "(Optional Action)\r\nKey sequence from variable '$phone' with focus on 'AdminWebapp.Root.Text'.", repo.AdminWebapp.Root.TextInfo, new RecordItemIndex(41));
            ...
            try {
                Report.Log(ReportLevel.Info, "Keyboard", "(Optional Action)\r\nKey 'Enter' Press.", new RecordItemIndex(43));
                Keyboard.Press(System.Windows.Forms.Keys.Return, Keyboard.DefaultScanCode, Keyboard.DefaultKeyPressTime, 1, true);
                Delay.Milliseconds(0);
            ...
            try {
                Report.Log(ReportLevel.Info, "Keyboard", "(Optional Action)\r\nKey 'Ctrl+R' Press.", new RecordItemIndex(46));
                Keyboard.Press(System.Windows.Forms.Keys.R | System.Windows.Forms.Keys.Control, Keyboard.DefaultScanCode, Keyboard.DefaultKeyPressTime, 1, true);
                Delay.Milliseconds(0);
            } catch(Exception ex) { Report.Log(ReportLevel.Warn, "Module", "(Optional Action) " + ex.Message, new RecordItemIndex(46)); }
            
            try {
                Report.Log(ReportLevel.Info, "Delay", "(Optional Action)\r\nWaiting for 5s.", new RecordItemIndex(47));
                Delay.Duration(5000, false);
            } catch(Exception ex) { Report.Log(ReportLevel.Warn, "Module", "(Optional Action) " + ex.Message, new RecordItemIndex(47)); }
            
            try {
                Report.Log(ReportLevel.Info, "Validation", "(Optional Action)\r\nValidating AttributeEqual (TagName='ul') on item 'AdminWebapp1.Root.DropdownMenu1'.", repo.AdminWebapp1.Root.DropdownMenu1Info, new RecordItemIndex(48));
